...
var questionsArray = {
    ...
    answers: {
        text1: {text: 'console.log', correct: true},
        text2: {text: 'message.log', correct: true},
        text3: {text: 'querySelector', correct: true},
        text4: {text: 'event.target', correct: true},
        }
    },
    ...
    answers: {
        text1: {text: 'Document Objective Module', correct: false},
        text2: {text: 'Document Object Model', correct: true},
        text3: {text: 'Dominant Order Model', correct: false},
        text4: {text: 'Dominant Object Mass', correct: false},
        }
    },
    ...
    answers: {
        text1: {text: 'pasteElement', correct: false},
        text2: {text: 'glueChild', correct: false},
        text3: {text: 'appendChild', correct: true},
        text4: {text: 'appendElement', correct: false},
        }
    }
...
console.log(questionsArray[1].answers.text1);
...
// adding functions for prompts and options to show
    ...
    //     console.log(questionsArray[0]);
    //     individualQuestions(randomQuestion);
...
var individualQuestions = function(){
    ...
    quizBox.innerHTML = questionsArray[i].question;
...
var chooseAnswer = function(){
    ...
    optionBtn1.innerHTML = questionArray[i].answers.text1.text;
